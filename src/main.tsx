...
import "./redux/features/categories/categoriesApi";
import "./redux/features/material/materialApi";
import "./redux/features/units/unitsApi";
import "./redux/features/purchases-management/purchasesManagementApi";
import { initializeSampleData } from "./moc/localStorageUtils";

const config = {
  token: {
    colorPrimary: "#ff3d0a",
    colorLink: "#ff3d0a",
    colorPrimaryBg: "#ff3d0a30",
  },
};
