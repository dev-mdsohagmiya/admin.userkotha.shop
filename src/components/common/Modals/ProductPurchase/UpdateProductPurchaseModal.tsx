...
import { useUpdateProductPurchaseMutation } from "../../../../redux/features/product-purchase/productPurchaseApi";
...
interface UpdateProductPurchaseModalProps {
  open: boolean;
  setOpen: React.Dispatch<React.SetStateAction<boolean>>;
  purchase: any;
}

const UpdateProductPurchaseModal: React.FC<UpdateProductPurchaseModalProps> = ({
  open,
  setOpen,
  purchase,
}) => {
  ...
  return (
    ...
    >
      <PageMeta
        title="Update Product Purchase"
        description="Update existing product purchase"
      />
      ...
      >
        ...
        <div className="flex justify-end gap-2 w-full mt-4 border-t pt-4">
          <Button
            ...
            type="default"
            className="px-6 h-9 font-medium rounded-lg"
          >
            Cancel
          </Button>
          <Button
            ...
            htmlType="submit"
            loading={isLoading}
            className="px-6 h-9 font-bold rounded-lg"
          >
            Update Purchase
          </Button>
        </div>
...
export default UpdateProductPurchaseModal;
