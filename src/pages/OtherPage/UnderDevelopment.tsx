  ...
  return (
    <div className="flex min-h-[80vh] flex-col items-center justify-center bg-gray-50 px-4 text-center">
      ...
      <p className="mb-2 text-gray-500">
        ...
        <code className="text-green-600 font-medium">{location.pathname}</code>
      </p>
      ...
      <button
        onClick={() => navigate("/")}
        className="rounded-md bg-green-600 px-6 py-3 text-white font-medium shadow hover:bg-green-700 transition"
      >
        Go to Dashboard
      </button>
    </div>
